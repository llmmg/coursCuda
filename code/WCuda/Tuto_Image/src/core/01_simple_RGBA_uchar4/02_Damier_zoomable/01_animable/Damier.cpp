 ...
 */
void Damier::processForAutoOMP(uchar4* ptrTabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
 ...
 */
void Damier::processEntrelacementOMP(uchar4* ptrTabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
    DamierMath damierMath(n); // ici pour preparer cuda
